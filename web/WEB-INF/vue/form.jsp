...
<form method="post" action="createPestacle">
    <fieldset>
        ...
        <span class="error">${form.error["name"]}</span>
        <br />
        ...
        <span class="error">${form.error['place']}</span>
        <br />
